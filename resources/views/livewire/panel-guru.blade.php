<div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div
            ...
            <canvas id="mean" class="mx-16 md:mx-36 lg:mx-40"></canvas>
        </div>
        <div
            class="hidden sm:block hover:scale-[1.02] p-5  bg-gray-100 border-2 hover:shadow-2xl hover:bg-gray-50 transition duration-200 rounded-lg dark:bg-gray-800 ">
...
@push('scripts')
    ...
    <script>
        ...
        // Data untuk grafik
        const labelsBar = @json(
            $pakets->map(function ($item) {
                    return $item->nama;
                })->toArray());
        const dataBar = @json(
            $pakets->map(function ($item) {
