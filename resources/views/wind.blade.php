...
<body>
    ...
    <nav class="fixed top-0 z-50 shadow-xl w-full bg-gradient-to-r from-primary-600  to-primary-950 ">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        aria-controls="logo-sidebar" type="button"
                        class="inline-flex items-center p-2 text-sm text-white hover:text-primary-950 transition  rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#"
                        ...
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-white bg-gray-100 rounded-full dark:bg-gray-700 dark:text-white">Pro</span>
                    </a>
                </li>
                <li>
                    <a href="#"
